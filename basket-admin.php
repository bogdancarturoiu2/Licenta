...
<body>
    ...
    <section class="teams-basket" id="teams">
        <div class="container">
            <h2 class="title">Echipe de Basket</h2>
            <div class="carousel owl-carousel">
                <div class="card">
                    <div class="box">
                        <img src="https://cdn-icons-png.flaticon.com/128/9920/9920968.png" alt="">
                        <div class="text">Leii Albaștrii</div>
                        <a href="leii-albastrii-admin.php" class="btn">Înscrie-te</a>
                    </div>
                </div>
                <div class="card">
                    <div class="box">
                        <img src="https://cdn-icons-png.flaticon.com/128/8062/8062742.png" alt="">
                        <div class="text">Leii Roșii</div>
                        <a href="" class="btn">Înscrie-te</a>
                    </div>
                </div>
                <div class="card">
                    <div class="box">
                        <img src="https://cdn-icons-png.flaticon.com/128/4081/4081551.png" alt="">
                        <div class="text">Leii Verzi</div>
                        <a href="" class="btn">Înscrie-te</a>
                    </div>
                </div>
                <div class="card">
                    <div class="box">
                        <img src="https://cdn-icons-png.flaticon.com/128/7963/7963154.png" alt="">
                        <div class="text">Tigrii Albaștrii</div>
                        <a href="" class="btn">Înscrie-te</a>
                    </div>
                </div>
                <div class="card">
                    <div class="box">
                        <img src="https://cdn-icons-png.flaticon.com/128/4688/4688508.png" alt="">
                        <div class="text">Tigrii Roșii</div>
                        <a href="" class="btn">Înscrie-te</a>
                    </div>
                </div>
                <div class="card">
                    <div class="box">
                        <img src="https://cdn-icons-png.flaticon.com/128/10197/10197722.png" alt="">
                        <div class="text">Tigrii Verzi</div>
                        <a href="" class="btn">Înscrie-te</a>
                    </div>
                </div>
            </div>
        ...
        <div class="admin-pannel-match">
            <div class="container">
                <h2>Calendar Competiții Basket</h2>
                <a href="add-new-basket.php" class="btn">Adaugă</a>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="edit-basket.php?id=<?php echo $row["id"] ?>"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a> &nbsp;
                                    <a href="delete-basket.php?id=<?php echo $row["id"] ?>"><i class="fa-solid fa-trash fs-5"></i></a>
                                </td>
                            </tr>
                        <?php
                        }
