    ...
    <section class="teams" id="teams">
            ...
            <div class="carousel owl-carousel">
                <div class="card">
                    <div class="box">
                        ...
                        <a href="vulturii-albastrii-admin.php" class="btn">Înscrie-te</a>
                    </div>
                </div>
                <div class="card">
                    <div class="box">
        ...
        <div class="admin-pannel-match">
            <div class="container">
                ...
                <a href="add-new-football.php" class="btn">Adaugă</a>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="edit-football.php?id=<?php echo $row["id"] ?>"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a> &nbsp;
                                    <a href="delete-football.php?id=<?php echo $row["id"] ?>"><i class="fa-solid fa-trash fs-5"></i></a>
                                </td>
                            </tr>
                        <?php
                        }
