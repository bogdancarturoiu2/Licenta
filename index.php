    ...
    <section class="main" id="main">
        <div class="container">
            <div class="main-content">
                ...
                <a href="activities-user.php">Alătură-te nouă</a>
            </div>
        </div>
    </section>
            ...
            <div class="activities-content">
                <div class="card">
                    <div class="box">
                        ...
                        <a href="football-user.php" class="btn">Află mai multe</a>
                    </div>
                </div>
                <div class="card">
                    <div class="box">
    ...
    <section class="gallery" id="gallery">
        <div class="container">
            ...
            <div class="carousel owl-carousel">
                <div class="card">
                    <div class="box">
                        <img src="https://plus.unsplash.com/premium_photo-1685055940245-0f4b3fb736ce?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8Zm9vdGJhbGx8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60" alt="">
                    </div>
                </div>
                <div class="card">
                    <div class="box">
