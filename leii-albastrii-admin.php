...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO `leiialbastrii`(`id`, `lastname`, `firstname`, `specialization`, `date`,`hour`,`location`) VALUES (NULL,'$lastname','$firstname','$specialization','$date','$hour','$location')";
...
<body>
    ...
    <section class="reg-team-leii-albastrii">
        <div class="registration-in-team">
            <header>Înscrie-te în echipă</header>
            <form action="leii-albastrii-admin.php" method="post" class="form">
                <div class="input-box">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="edit-leii-albastrii.php?id=<?php echo $row["id"] ?>"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a> &nbsp;
                                    <a href="delete-leii-albastrii.php?id=<?php echo $row["id"] ?>"><i class="fa-solid fa-trash fs-5"></i></a>
                                </td>
                            </tr>
                        <?php
                        }
