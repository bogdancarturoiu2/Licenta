...
if (isset($_POST["submit"])) {
    ...
    if ($result) {
        $_SESSION['success']  = "User creat cu succes!"; //de intrebat
        header('location: vulturii-albastrii-user.php');
    } else {
...
<body>
    ...
    <section class="reg-team">
        <h1 class="title">Vulturii Albaștrii</h1>
        <div class="registration-in-team">
            <header>Înscrie-te în echipă</header>
            <form action="vulturii-albastrii-user.php" method="post" class="form">
                <div class="input-box">
                ...
                <div class="input-box">
                    <div class="select-box">
                        <select name="specialization">
                            <option hidden>Facultatea</option>
                            <option>Facultatea de Medicină</option>
                            <option>Facultatea de Medicina Dentară</option>
