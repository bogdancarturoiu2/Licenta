...
if (isset($_POST["submit"])) {
    ...
    $sql = "UPDATE `vulturiialbastrii` SET `lastname`='$lastname',`firstname`='$firstname',`specialization`='$specialization',`date`='$date',`hour`='$hour', `location`='$location' WHERE id = $id";
...
<head>
    ...
    <title>UMFST Connect - Editeaza echipa Vulturii Albastrii</title>
</head>

<body>
    <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #f97b22;">
        <h2> Editeaza echipa Vulturii Albastrii </h2>
    </nav>
    <div class="container">

        <?php
        $sql = "SELECT * FROM `vulturiialbastrii` WHERE id = $id LIMIT 1";
        $result = mysqli_query($db, $sql);
        ...
        <div class="container d-flex justify-content-center">
            <form action="" method="post" style="width:50vw; min-width:300px;">
                ...
                <div>
                    ...
                    <a href="vulturii-albastrii-admin.php" class="btn btn-danger">Cancel</a>
                </div>
            </form>
        </div>
    </div>
